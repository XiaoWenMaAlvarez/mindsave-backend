import type { ArchivoChatIA, ChatChatIA, MensajeChatIA } from "../entities/init.js";
...
export abstract class ChatIADatasource {
  ...
  abstract getFilesForChatDeletion(idChat: string, idUsuario: string): Promise<ArchivoChatIA[] | null>;
